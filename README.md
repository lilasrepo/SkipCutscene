...
讓你能跳過任務輪替（主線劇情）等場合的過場動畫，省下重複觀看的時間。

Lets you skip cutscenes such as those in Duty Roulette: Main Scenario, saving you from rewatching them.
...
本專案 fork 自 **[KangasZ/SkipCutscene](https://github.com/KangasZ/SkipCutscene)**，授權沿用上游；所有原始功能著作權歸 **KangasZ**。<br>
Forked from **[KangasZ/SkipCutscene](https://github.com/KangasZ/SkipCutscene)**. License follows upstream; all original work © **KangasZ**.
